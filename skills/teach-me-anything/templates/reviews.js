/* Retention queue for this workspace — the spaced-review engine reads and rewrites this.
   ...
   One entry per idea or micro-skill worth keeping — proposed by the tutor, confirmed or
   added by the learner. Schema + scheduling: ../formats/reviews.md

   Each entry:
     { id, prompt, recall, kind: "fact"|"skill", box: 1..6, due: "YYYY-MM-DD",
       lesson: "lessons/....html", added: "YYYY-MM-DD",
       source: "lesson"|"learner"|"assessment" }
   New items enter at box 1, due tomorrow. Boxes widen: 1d, 3d, 7d, 16d, 35d, 90d.
   The console shows at most six due items a day, shakiest first; the rest wait. */
window.REVIEW = [
